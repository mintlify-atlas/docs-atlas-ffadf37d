...
<ParamField path="layer" type="string" required>
  Layer identifier ('pre' or 'req')
</ParamField>

#### Returns

<ResponseField name="layerInfo" type="object">
  Object containing layer display information
...
<ResponseField name="patientName" type="string">
